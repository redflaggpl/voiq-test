...
class CCodeGenerator extends Controller
{
	...
	public $title='Generator';
	public $subTitle='Generator code';
	...
	public function actionModelsDynamic()
	{
		$modelClass=Yii::import($this->codeModel,true);
		$data=$this->module->getListDataModels($_POST[$modelClass]['moduleName'],$this->codeModel);
