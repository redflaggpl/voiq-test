...
class Email_passwordController extends CmsController
{
	public $defaultAction='index';
	public $title='<i class="fa fa-envelope"></i> Password email copies';
	public $subTitle='Admin Password email copies';
	...
	{
		$this->title='<i class="fa fa-envelope"></i> '.Yii::t('app','Password email copies');
		$this->subTitle='Admin '.Yii::t('app','Password email copies');
