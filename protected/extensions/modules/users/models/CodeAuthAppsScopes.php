...
/**
 * This is the model class for table "users_code_auth_apps_scopes".
 *
 * The followings are the available columns in table 'users_code_auth_apps_scopes':
 * @property integer $id
 * @property integer $apps_id
 * @property integer $scopes_id
 */
class CodeAuthAppsScopes extends CActiveRecord
{
	/**
	...
	{
		return 'users_code_auth_apps_scopes';
	}
	 ...
	 * @return CodeAuthAppsScopes the static model class
	 */
