...
$this->breadcrumbs=array(
 ...
 ?>
<div class="col-lg-12">
<?php if(Yii::app()->user->check('root')):?>
...
<!-- //////////////////////////////////// -->
<!-- Publicacion del javascript asociado  -->
<!-- a la opción de enviar contraseña    -->
<!-- //////////////////////////////////// -->
<?php Yii::app()->clientScript->registerScript("resendPassword","
  $(document).on('click', '[data-action=resend]', function(e) {
    e.preventDefault();
    var that=$(this);
    var content=that.html();
    	that.html('...');
