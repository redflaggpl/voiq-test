...
<table cellpadding="0" cellspacing="0" align="center" border="0">
	<tbody>
		<tr style="color:#a8b9c6;font-size:11px;font-family:'Open Sans','Lucida Grande','Segoe UI',Arial,Verdana,'Lucida Sans Unicode',Tahoma,'Sans Serif'">
			...
			<td width="228" align="right" style="color:#53B6CF;text-align:right">© 2014 <a style="text-decoration: none;color:#53B6CF;" href="http://adpsicologia.com/inicio/" target="_blank" style="color:#53B6CF;">adpsicologia.com/inicio</a></td>
		</tr>
	</tbody>
</table>
